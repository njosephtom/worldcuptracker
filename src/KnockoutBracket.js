...
const BD = {
  72: { r:'R32', p:0,  h:'1 E',  a:'3+ABCDF', pid:88 },
  73: { r:'R32', p:1,  h:'1 C',  a:'2 F',      pid:88 },
  74: { r:'R32', p:2,  h:'1 I',  a:'3+CDFGH', pid:89 },
  75: { r:'R32', p:3,  h:'2 E',  a:'2 I',      pid:89 },
  76: { r:'R32', p:4,  h:'2 A',  a:'2 B',      pid:90 },
  77: { r:'R32', p:5,  h:'1 A',  a:'3+CEFHI', pid:90 },
  78: { r:'R32', p:6,  h:'1 F',  a:'2 C',      pid:91 },
  79: { r:'R32', p:7,  h:'1 L',  a:'3+EHIJK', pid:91 },
  80: { r:'R32', p:8,  h:'2 K',  a:'2 L',      pid:92 },
  81: { r:'R32', p:9,  h:'1 J',  a:'2 H',      pid:92 },
  82: { r:'R32', p:10, h:'1 H',  a:'2 J',      pid:93 },
  83: { r:'R32', p:11, h:'2 D',  a:'2 G',      pid:93 },
  84: { r:'R32', p:12, h:'1 D',  a:'3+BEFIJ', pid:94 },
  85: { r:'R32', p:13, h:'1 G',  a:'3+AEHIJ', pid:94 },
  86: { r:'R32', p:14, h:'1 B',  a:'3+EFGIJ', pid:95 },
  87: { r:'R32', p:15, h:'1 K',  a:'3+DEIJL', pid:95 },
...
function slotLine(slot) {
  ...
  if (slot.startsWith('3+'))     return { main:'3 ' + slot.slice(2), sub:null, tbd:true };
